...
namespace ADONETCORE
{
    public partial class Form14Settings : Form
    {
        ...
        private void btnLeerSettings_Click(object sender, EventArgs e)
        {
            ...
            builder.SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile("C:\\Users\\oskit\\Entorno_desarrollo\\Master\\NetCore\\ADONETCORE\\ADONETCORE\\appSettings.json", false, true);
              IConfigurationRoot configuration = builder.Build();
            string connecctionString = configuration.GetConnectionString("SqlTajamar");
            this.lblCadenaConexion.Text = connecctionString;
